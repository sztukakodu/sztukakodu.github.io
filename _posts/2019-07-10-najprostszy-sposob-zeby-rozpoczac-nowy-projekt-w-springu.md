...
1. wejść na stronę [start.spring.io](https://start.spring.io) i mieć to z głowy ;)
...
Wypiszmy jeszcze standardowe *Hello, World* by sprawdzić jak całość ze sobą działa.
W tym celu edytuj plik `MyAppApplication.java` i dodaj *beana* implementującego interfejs `CommandLineRunner`.
...
Jeśli chcesz, na [start.spring.io](https://start.spring.io) możesz już od razu dodawać potrzebne zależności (*dependencies*) do Twojego projektu, ale równie dobrze możesz zacząć z minimalnym zestawem a potem dodawać kolejne elementy w ramach potrzeb, gdy Twój projekt będzie się rozwijał.
